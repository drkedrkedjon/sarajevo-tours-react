export default [
  ...
  //   description:
  //     "Jahorina mountain, located in Bosnia and Herzegovina, is a popular destination for mountain biking enthusiasts. The mountain offers a range of trails suitable for different levels of experience and skills, from easy and relaxing rides to more challenging and technical routes.\n\n Some of the popular trails on Jahorina mountain include the XC trail, which offers a scenic ride through forests and meadows, and the DH trail, which is more challenging and includes jumps, drops, and steep descents.\n\n The bike park on the mountain offers a variety of features, including a pump track, wooden bridges, and jumps. The scenery on Jahorina mountain is also breathtaking, with stunning views of the surrounding mountains and valleys.\n\n The mountain is also home to a variety of flora and fauna, including wildflowers, birds, and small mammals. Overall, mountain biking on Jahorina mountain is a great way to experience the beauty of the region while also enjoying an adrenaline-pumping outdoor activity.",
  //   price: "25",
  //   category: "bike",
  //   type: "single",
  //   imgUrl: "/assets/images/products/bike/mtb-ja-1.jpg",
  //   imgUrl2: "/assets/images/products/bike/mtb-ja-2.jpg",
  // },
  // {
  //   id: "11",
  ...
  //     "The mountain offers a range of trails suitable for different levels of experience and skills, from easy and relaxing rides to more challenging and technical routes.",
  //   description:
  //     "Bjelasnica mountain, located in Bosnia and Herzegovina, is a popular destination for mountain biking enthusiasts. The mountain offers a range of trails suitable for different levels of experience and skills, from easy and relaxing rides to more challenging and technical routes.\n\n Some of the popular trails on Bjelasnica mountain include the XC trail, which offers a scenic ride through forests and meadows, and the DH trail, which is more challenging and includes jumps, drops, and steep descents. The bike park on the mountain offers a variety of features, including a pump track, wooden bridges, and jumps. \n\n The scenery on Bjelasnica mountain is also breathtaking, with stunning views of the surrounding mountains and valleys. The mountain is also home to a variety of flora and fauna, including wildflowers, birds, and small mammals.\n\n Overall, mountain biking on Bjelasnica mountain is a great way to experience the beauty of the region while also enjoying an adrenaline-pumping outdoor activity.",
  //   price: "25",
  //   category: "bike",
  //   type: "single",
  //   imgUrl: "/assets/images/products/bike/mtb-bj-1.jpg",
  //   imgUrl2: "/assets/images/products/bike/mtb-bj-2.jpg",
  // },
  // {
  //   id: "12",
  //   title: "MTB in Bosnia",
  ...
  //     "The mountain offers a range of trails suitable for different levels of experience and skills, from easy and relaxing rides to more challenging and technical routes.",
  //   description:
  //     "Bjelasnica mountain, located in Bosnia and Herzegovina, is a popular destination for mountain biking enthusiasts. The mountain offers a range of trails suitable for different levels of experience and skills, from easy and relaxing rides to more challenging and technical routes. \n\nS ome of the popular trails on Bjelasnica mountain include the XC trail, which offers a scenic ride through forests and meadows, and the DH trail, which is more challenging and includes jumps, drops, and steep descents. \n\n The bike park on the mountain offers a variety of features, including a pump track, wooden bridges, and jumps. The scenery on Bjelasnica mountain is also breathtaking, with stunning views of the surrounding mountains and valleys. The mountain is also home to a variety of flora and fauna, including wildflowers, birds, and small mammals. \n\n Overall, mountain biking on Bjelasnica mountain is a great way to experience the beauty of the region while also enjoying an adrenaline-pumping outdoor activity.",
  //   price: "40",
  //   category: "bike",
  //   type: "multi",
  //   imgUrl: "/assets/images/products/bike/mtb-ja-3.jpg",
  //   imgUrl2: "/assets/images/products/bike/mtb-bj-3.jpg",
  // },
  // *******************
  // {
  //   id: "20",
  ...
  //   category: "walk",
  //   type: "food",
  //   imgUrl: "/assets/images/products/walk/food-1.jpg",
  //   imgUrl2: "/assets/images/products/walk/food-2.jpg",
  // },
  // {
  //   id: "21",
  ...
  //     "The city's culinary scene is diverse and offers something for everyone, whether you're looking for meat dishes, vegetarian options, or sweet treats.",
  //   description:
  //     "Sarajevo, the capital city of Bosnia and Herzegovina, has a rich culinary tradition that reflects its Ottoman and Austro-Hungarian heritage. Some of the traditional dishes that you can find in Sarajevo include: \n\n Cevapi: These are small sausages made from minced beef or lamb, typically served with pita bread and onions. \n\n  Burek: A savory pastry made with phyllo dough and stuffed with meat, cheese, or spinach. \n\n  Dolma: Stuffed vegetables such as peppers or grape leaves filled with a mixture of rice, herbs, and sometimes meat. \n\n  Bosanski lonac: A hearty meat and vegetable stew typically made with lamb, potatoes, carrots, and onions. \n\n  Klepe: Similar to Italian ravioli, klepe are small dumplings filled with meat or cheese and served in a broth. \n\n  Sarajevski sahan: A dish consisting of baked meatballs, potatoes, and onions in a tomato sauce.  \n\n These are just a few examples of the many delicious traditional dishes that you can try in Sarajevo. The city's culinary scene is diverse and offers something for everyone, whether you're looking for meat dishes, vegetarian options, or sweet treats.",
  //   price: "25",
  //   category: "walk",
  //   type: "food",
  //   imgUrl: "/assets/images/products/walk/food-3.jpg",
  //   imgUrl2: "/assets/images/products/walk/food-4.jpg",
  // },
  // {
  //   id: "22",
  ...
  //   description:
  //     "Sarajevo, the capital city of Bosnia and Herzegovina, has a rich culinary tradition that combines various cultural influences from the region. When it comes to sweet culinary delights, Sarajevo offers a wide range of desserts and pastries that are both delicious and unique. \n\n One of the most famous sweet treats in Sarajevo is baklava, a pastry made of layers of phyllo dough filled with chopped nuts and sweet syrup. Baklava can be found in many bakeries and restaurants throughout the city and is often served with a cup of strong Bosnian coffee.  \n\n Another popular dessert in Sarajevo is tufahija, which is made of poached apples stuffed with a mixture of walnuts, sugar, and cinnamon and served with whipped cream. Tufahija is a traditional Bosnian dessert that is typically enjoyed during the winter months. \n\n  A similar dessert to tufahija is hurmasice, which are small, syrup-soaked cakes made with semolina flour, sugar, and walnuts. These cakes are usually flavored with rose water or vanilla and are a popular treat during Eid al-Fitr, a holiday celebrated at the end of Ramadan. \n\n  Another traditional Bosnian sweet is klepe, which are small, dumpling-like pastries filled with plum jam or quince paste and served with a sprinkling of sugar. Klepe can be found in many bakeries throughout Sarajevo and are often served as a sweet breakfast or snack. \n\n  Other sweet treats that can be found in Sarajevo include rahat lokum (Turkish delight), halva (a sweet made from sesame paste and sugar), and pita sa jabukama (apple pie). Overall, Sarajevo's sweet culinary scene is diverse and flavorful, with many unique and delicious desserts to try.",
  //   price: "25",
  //   category: "walk",
  //   type: "food",
  //   imgUrl: "/assets/images/products/walk/sweet-1.jpg",
  //   imgUrl2: "/assets/images/products/walk/sweet-3.jpg",
  // },
  // {
  //   id: "25",
  //   title: "History spots in Sarajevo",
  //   subtitle:
  //     "Rich architecture that reflects its Ottoman and Austro-Hungarian heritage",
  //   hero: {
  //     heroTitle: "Sarajevo",
  //     heroText: "Historic buildings and architecture. GPS guide.",
  //   },
  //   summary:
  //     "Sarajevo, the capital city of Bosnia and Herzegovina, was part of the Ottoman Empire for over four centuries, from the mid-15th century until the late 19th century.",
  //   description:
  //     "Sarajevo, the capital city of Bosnia and Herzegovina, was part of the Ottoman Empire for over four centuries, from the mid-15th century until the late 19th century. As a result, the city is home to numerous Ottoman spots and buildings that showcase the rich cultural heritage of the Ottoman period. Here are some of the most notable historic Ottoman spots and buildings in Sarajevo: \n\n Baščaršija: Baščaršija is the historic center of Sarajevo and was built by the Ottomans in the 15th century.It is a labyrinthine neighborhood of narrow streets and alleys lined with shops selling traditional crafts, copperware, jewelry, and souvenirs.Baščaršija is also home to several Ottoman- era buildings, including the Gazi Husrev - bey Mosque, the largest mosque in Sarajevo. \n\n Gazi Husrev - bey Mosque: The Gazi Husrev - bey Mosque was built in the 16th century by the Ottoman governor of Bosnia, Gazi Husrev - bey.It is one of the most important Islamic structures in the Balkans and is renowned for its intricate calligraphy, colorful stained glass windows, and beautiful tilework. \n\n  Sebilj: Sebilj is a wooden fountain located in the heart of Baščaršija.It was built in the 18th century and is one of the most iconic symbols of Sarajevo.Sebilj is surrounded by benches and is a popular meeting spot for locals and tourists alike.\n\n Bezistan: Bezistan is a covered market located in the heart of Baščaršija.It was built in the 16th century and was originally used as a place for trading textiles and other goods.Today, Bezistan is home to several shops selling traditional Bosnian crafts and souvenirs. \n\n Morića Han: Morića Han is a traditional Ottoman - style inn located in the old town of Sarajevo.It was built in the 16th century and was used as a resting place for travelers and merchants.Today, Morića Han is home to several shops and cafes. \n\n Emperor's Mosque: The Emperor's Mosque is one of the oldest mosques in Sarajevo, dating back to the 15th century.It was built by the Ottoman Sultan Mehmed the Conqueror and is renowned for its intricate tilework and calligraphy. \n\n Vijećnica: Vijećnica is a magnificent neo - Moorish building located in the heart of Sarajevo's old town. It was built in 1896 as the city hall during Austro-Hungarian rule and was designed by the Czech architect Karel Pařík. Today, it houses the National and University Library of Bosnia and Herzegovina.",
  //   price: "25",
  //   category: "walk",
  //   type: "history",
  //   imgUrl: "/assets/images/products/walk/history-1.jpg",
